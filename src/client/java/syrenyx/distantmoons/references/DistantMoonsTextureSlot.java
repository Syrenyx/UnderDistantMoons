...
public abstract class DistantMoonsTextureSlot {
  ...
  public static final TextureSlot FRONT_LEFT_LIT = TextureSlot.create("front_left_lit");
  public static final TextureSlot FRONT_LEFT_SOUL_FIRE = TextureSlot.create("front_left_soul_fire");
  public static final TextureSlot FRONT_LEFT_UNLIT = TextureSlot.create("front_left_unlit");
  ...
  public static final TextureSlot SIDE_TOP = TextureSlot.create("side_top");
