  ...
  protected RecipeGenerator getRecipeGenerator(RegistryWrapper.WrapperLookup registryLookup, RecipeExporter recipeExporter) {
    return new RecipeGenerator(registryLookup, recipeExporter) {
      ...
      public void generate() {
        ...
        this.createSlabRecipes(Items.BASALT, DistantMoonsBlocks.CUT_BASALT);
        ...
        this.createSlabRecipes(Items.BONE_BLOCK, DistantMoonsBlocks.CUT_BONE_BLOCK);
        ...
        this.createSlabRecipes(Items.DEEPSLATE, DistantMoonsBlocks.CUT_DEEPSLATE);
        ...
        this.createSlabRecipes(Items.PURPUR_PILLAR, DistantMoonsBlocks.CUT_PURPUR_PILLAR);
        this.createSlabRecipes(Items.QUARTZ_PILLAR, DistantMoonsBlocks.CUT_QUARTZ_PILLAR);
        ...
        this.createSlabRecipes(Items.POLISHED_BASALT, DistantMoonsBlocks.POLISHED_CUT_BASALT);
      ...
      private void createWallSlabRecipes(ItemConvertible ingredient, ItemConvertible result, String group) {
        this.createWallSlabCraftingRecipe(ingredient, result, group);
        this.createSlabCuttingRecipe(ingredient, result);
      }

      private void createWallSlabCraftingRecipe(ItemConvertible ingredient, ItemConvertible result, String group) {
        this.createShaped(RecipeCategory.BUILDING_BLOCKS, result, 6)
            .group(group)
