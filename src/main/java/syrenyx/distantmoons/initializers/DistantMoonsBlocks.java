...
public abstract class DistantMoonsBlocks {
  ...
  public static final Block BAMBOO_MOSAIC_WALL_SLAB = register(
      ...
      WallSlabBlock::new,
      BlockBehaviour.Properties.ofFullCopy(Blocks.BAMBOO_MOSAIC),
      new Item.Properties()
  );
  ...
  public static final Block CUT_CRIMSON_HYPHAE = register(
      "cut_crimson_hyphae",
      PillarSlabBlock::new,
      BlockBehaviour.Properties.ofFullCopy(Blocks.CRIMSON_HYPHAE),
      new Item.Properties()
  );
  ...
  public static final Block CUT_DARK_OAK_WOOD = register(
      "cut_dark_oak_wood",
      PillarSlabBlock::new,
      BlockBehaviour.Properties.ofFullCopy(Blocks.DARK_OAK_WOOD),
      new Item.Properties()
  );
  ...
  public static final Block CUT_JUNGLE_WOOD = register(
      "cut_jungle_wood",
      PillarSlabBlock::new,
      BlockBehaviour.Properties.ofFullCopy(Blocks.JUNGLE_WOOD),
      new Item.Properties()
  );
  ...
  public static final Block CUT_PALE_OAK_LOG = register(
      "cut_pale_oak_log",
      PillarSlabBlock::new,
      BlockBehaviour.Properties.ofFullCopy(Blocks.PALE_OAK_LOG),
      new Item.Properties()
  );
  public static final Block CUT_PALE_OAK_WOOD = register(
      "cut_pale_oak_wood",
      PillarSlabBlock::new,
      BlockBehaviour.Properties.ofFullCopy(Blocks.PALE_OAK_WOOD),
      new Item.Properties()
  );
  ...
  public static final Block PALE_PRISMARINE_WALL = register(
      ...
      WallBlock::new,
      BlockBehaviour.Properties.ofFullCopy(Blocks.PRISMARINE_WALL)
          .mapColor(MapColor.TERRACOTTA_WHITE),
      new Item.Properties()
  );
  ...
  public static final Block STRIPPED_CUT_CRIMSON_HYPHAE = register(
      ...
      PillarSlabBlock::new,
      BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_CRIMSON_HYPHAE),
      new Item.Properties()
  );
  ...
  public static final Block STRIPPED_CUT_DARK_OAK_WOOD = register(
      ...
      PillarSlabBlock::new,
      BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_DARK_OAK_WOOD),
      new Item.Properties()
  );
  ...
  public static final Block STRIPPED_CUT_JUNGLE_WOOD = register(
      ...
      PillarSlabBlock::new,
      BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_JUNGLE_WOOD),
      new Item.Properties()
  );
  ...
  public static final Block STRIPPED_CUT_MANGROVE_WOOD = register(
      ...
      PillarSlabBlock::new,
      BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_MANGROVE_WOOD),
      new Item.Properties()
  );
  ...
  public static final Block STRIPPED_CUT_PALE_OAK_WOOD = register(
      ...
      PillarSlabBlock::new,
      BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_PALE_OAK_WOOD),
      new Item.Properties()
  );
