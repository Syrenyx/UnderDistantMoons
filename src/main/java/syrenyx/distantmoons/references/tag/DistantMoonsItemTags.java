...
public abstract class DistantMoonsItemTags {
  ...
  public static final TagKey<Item> SMELTING_FUEL_WOOD_BLOCK = TagUtil.generateKey(RegistryKeys.ITEM, "fuel/smelting/wood_block");
  public static final TagKey<Item> SMELTING_FUEL_WOOD_HALF_BLOCK = TagUtil.generateKey(RegistryKeys.ITEM, "fuel/smelting/wood_half_block");
