...
public abstract class DistantMoonsItemMaterials {
  ...
  public static final ArmorMaterial DEEP_IRON_ARMOR = new ArmorMaterial(
      30, createDefenseMap(2, 5, 6, 2, 5), 9, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F, 0.0F, DistantMoonsTags.REPAIRS_DEEP_IRON_EQUIPMENT, armorAssetRegistryKeyOf("deep_iron")
  );

  //TOOL MATERIALS
  public static final ToolMaterial DEEP_IRON_TOOL = new ToolMaterial(
      BlockTags.INCORRECT_FOR_IRON_TOOL, 500, 6.0F, 2.0F, 14, DistantMoonsTags.REPAIRS_DEEP_IRON_EQUIPMENT
  );
