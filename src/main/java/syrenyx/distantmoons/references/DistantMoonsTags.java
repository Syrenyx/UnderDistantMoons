...
public abstract class DistantMoonsTags {
  ...
  public static final TagKey<Block> WOODEN_FENCE = generateKey(RegistryKeys.BLOCK, "wooden_fence");
  public static final TagKey<Block> WOODEN_FENCE_ALWAYS_CONNECTS_TO = generateKey(RegistryKeys.BLOCK, "connection_target/wooden_fence/always");
  public static final TagKey<Block> WOODEN_FENCE_NEVER_CONNECTS_TO = generateKey(RegistryKeys.BLOCK, "connection_target/wooden_fence/never");
